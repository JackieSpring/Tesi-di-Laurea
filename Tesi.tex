...
\chapter{Scenario e ambiente sperimentale}
    ...
    informatico in cui si è svolta. La \Sezione{specifiche-e-piattaforma} è una rapida descrizione
    del sistema informatico usato durante il corso delle ricerche e dell'installazione
    Firefox utilizzata mentre la \Sezione{threat-scenario} illustra il modello di minaccia
    considerato. Infine la \Sezione{estensione-vuln} introduce all'estensione fantoccio 
    bersagliata dagli attacchi, verrà approfondita nel \Capitolo{attaccando-vuln}.

    \section{Specifiche applicazione e piattaforma}
    \label{specifiche-e-piattaforma}
    ...
    \label{threat-scenario}
        ...
        di ricerca dall'estensione \vuln di cui si parlerà nella \Sezione{estensione-vuln}.
    ...
    \label{estensione-vuln}
        ...
        \Sezione{threat-scenario} creando e installando nel browser una estensione che contenesse
...
\label{cap:attaccando-vuln}
    In questo capitolo tratterò le difese applicate all'ambiente delle estensioni e 
    indagherò i processi in atto dietro ai risultati dei miei tentativi d'attacco.
